                        ...
                        <div class="cta-inner bg-faded text-center rounded">
                           ...
                           <br><br>
                            <h2 class="section-heading mb-5">
	                        	<span style="display:inline;" class="section-heading-lower">아이디 찾기</span>
                            </h2>
...
<div class="div1"><div style=" width: 155px; border: 3px solid; border-radius: 4px; background-color:white; color:black; font-weight: 700;" for="user_name">*이름</div></div>
<div class="div2"><div><input id="user_name" type="text" placeholder="이름" name="user_name" style="border-radius: 5px;" value="${ user_name }" required/></div> </div>

<div class="div7"><div style=" width: 155px; border: 3px solid; border-radius: 4px; background-color:white; color:black; font-weight: 700;" for="email">*이메일</div></div>
<div class="div8"><input id="email" type="email" placeholder="이메일" name="email" style="border-radius: 5px;" value="${ email }" required/></div> </div>


<div class="div11"><input class="btn btn-primary btn-block" type="submit" value="아이디 찾기" onclick="javascript:location.href='findId.do';">
 </div>
